...
func (s *ModuleTestSuite) SetupTest() {
	...
	maccPerms := map[string][]string{
		...
		"mint":                          {"minter"},
		state.evoluteaiStakingAccountName:  {"burner", "minter", "staking"},
		state.evoluteaiRequestsAccountName: {"burner", "minter", "staking"},
		state.evoluteaiRewardsAccountName:  {"minter"},
