...
const evoluteaiStakingAccountName = "evoluteaistaking"
const evoluteaiRequestsAccountName = "evoluteairequests"
const evoluteaiRewardsAccountName = "evoluteairewards"
