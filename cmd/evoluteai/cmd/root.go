...
// NewRootCmd creates a new root command for evoluteaid. It is called once in the
// main function.
func NewRootCmd() *cobra.Command {
	...
	rootCmd := &cobra.Command{
		Use:   "evoluteaid",
		Short: "evoluteaid - the evoluteai chain",
...
func ProvideClientContext(
	...
	clientCtx := client.Context{}.
		...
		WithViper("evoluteai") // env variable prefix
